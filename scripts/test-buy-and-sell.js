...
/**
 * Test script to buy and sell tokens:
 * 1. Authenticate with x-request-signature
 * 2. Buy token for 0.5 SOL
 * 3. Verify purchase transaction
 * 4. Sell all tokens (100%)
 * 5. Verify sell transaction
 * 
 * Usage:
 *   # Uses WALLET_PRIVATE_KEY from .env file
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT_ADDRESS
 *   
 *   # Override private key via command line
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT --private-key YOUR_PRIVATE_KEY
 *   
 *   # Override API URL
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT --api-url http://localhost:3000
 *   
 *   # Override SOL amount (default: 0.5)
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT --sol-amount 1.0
 *   
 *   # Use Jito for faster transaction execution
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT --use-jito
 * 
 *   # Override slippage tolerance in basis points for sell (default: 1000 = 10%)
 *   node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT --slippage-bps 2000
 * 
...
async function main() {
  ...
  for (let i = 0; i < args.length; i++) {
    if (args[i] === '--private-key' && args[i + 1]) {
      ...
      tokenMint = args[i + 1];
      i++;
    } else if (args[i] === '--sell-percentage' && args[i + 1]) {
  ...
  if (!tokenMint) {
    ...
    console.error('Usage: node scripts/test-buy-and-sell.js --token-mint TOKEN_MINT_ADDRESS');
    process.exit(1);
  }
  ...
  try {
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('🚀 Testing Buy and Sell Flow');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    ...
    if (slippageBps !== null) {
      console.log(`Sell Slippage: ${slippageBps} bps (${slippageBps / 100}%)`);
    }
    console.log('');
    ...
    // Wait a bit before selling to ensure everything is settled
    console.log('\n⏳ Waiting 3 seconds before selling...\n');
    await new Promise(resolve => setTimeout(resolve, 3000));

    // Step 6: Sell token
    console.log('📝 Step 6: Selling token...');
    const sellPayload = {
      tokenMint: tokenMint,
    ...
    if (slippageBps !== null) {
      ...
      console.log(`   Using custom sell slippage: ${slippageBps} basis points (${slippageBps / 100}%)`);
    }
    ...
    // Step 7: Sign sell transaction
    console.log('📝 Step 7: Signing sell transaction...');
    ...
    // Step 8: Submit sell transaction
    console.log('📝 Step 8: Submitting sell transaction...');
    if (useJito) {
      console.log('   🚀 Using Jito for faster transaction execution');
    }
    ...
    // Step 9: Verify sell transaction
    console.log('📝 Step 9: Verifying sell transaction...');
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('✅ Full buy and sell flow completed successfully!');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
    console.log('📋 Summary:');
    ...
    console.log(`   Buy Amount: ${solAmount} SOL`);
    console.log(`   Sell Percentage: ${sellPercentage}%`);
    console.log(`   Buy Transaction: ${buyTxSignature}`);
    console.log(`   Sell Transaction: ${sellTxSignature}`);
    console.log(`   View Buy on Explorer: https://solscan.io/tx/${buyTxSignature}?cluster=devnet`);
    console.log(`   View Sell on Explorer: https://solscan.io/tx/${sellTxSignature}?cluster=devnet\n`);
